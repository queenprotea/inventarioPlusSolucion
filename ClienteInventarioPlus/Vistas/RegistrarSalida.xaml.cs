...
{
    public partial class RegistrarSalida : UserControl
    {
        ...
        public RegistrarSalida(Frame mainFrame, UsuarioDTO usuarioActual, IMovimientoService _proxy)
        {
            InitializeComponent();
        ...
        private void btnAceptar_Click(object sender, RoutedEventArgs e)
        {
            if (EntradasValidas())
            {
                ...
                if (producto == null)
                {
                    MessageBox.Show("Seleccione el producto en la tabla para el registro de salida.");
                    return;
                }
                ...
                { 
                    MessageBox.Show("La cantidad sobrepasa el sotck actual."); 
                    return;
                }
                ...
                entradaRegistro.TipoMovimiento = "Salida"; 
